...
class _AIBotState extends State<AIBot> {
  ...
  static const String apiKey ='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';
  ...
  Future<void> generateRecipe() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        showMessage('API usage limit for today has been exceeded. Please try again tomorrow.');
      }
    } catch (e) {
